...
import { EVENT_TYPES, type EvantaEvent } from "@/lib/events";

type Draft = Omit<EvantaEvent, "eventId">;
...
export default function EventFormModal({
  ...
  event: EvantaEvent | null;
  onClose: () => void;
  onSave: (draft: Draft, eventId?: string) => void;
}) {
  const [form, setForm] = useState<Draft>(event ? { ...event } : empty);
      ...
      <form className="row g-3" onSubmit={submit}>
        ...
        <div className="col-12 col-md-6">
          ...
          <input
            ...
            placeholder={form.eventType === "Other" ? "Describe your event" : "Select “Other”"}
          />
        </div>
        ...
        <div className="col-12 d-flex flex-wrap gap-2 justify-content-end pt-2">
          <button type="button" className="btn-evanta btn-evanta-ghost" onClick={onClose}>
            Cancel
          </button>
